...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Dábliu • Central de Resultados" },
      { name: "description", content: "Gestão comercial, metas e resultados em tempo real." },
    ],
  }),
  component: DabliuApp,
});
...
function DabliuApp() {
  ...
  const [sales, setSales] = useState<Sale[]>(() => {
    try { return JSON.parse(localStorage.getItem("dabliu-sales") || "null") || seedSales; } catch { return seedSales; }
  });
